...
`useRadioGroup` also supports [Standard Schema](https://github.com/standard-schema/standard-schema) validation through the `schema` prop.
...
| `schema`                | `StandardSchema<TValue>` | The [Standard Schema](https://github.com/standard-schema/standard-schema) to validate the radio group. |
