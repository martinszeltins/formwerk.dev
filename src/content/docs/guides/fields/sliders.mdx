...
The `useSlider` composable accepts a `schema` prop that is an instance of a Standard Schema.
...
| options     | `any[]`                  | Discrete slider values to represent the steps. |
| orientation | `Orientation`            | Orientation of the slider.                     |
| readonly    | `boolean`                | Whether the slider is readonly.                |
| schema      | `StandardSchema<number>` | Schema for the slider value.                   |
| step        | `number`                 | Step value for the slider.                     |
| value       | `number \| number[]`     | Initial value of the slider.                   |
