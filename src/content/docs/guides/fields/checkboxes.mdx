...
import StyledCheckboxPartial from './_partials/_checkboxStyled.mdx';
...
import StyledCheckboxGroupPartial from './_partials/_checkboxGroupStyled.mdx';
...
<div slot="Checkbox.vue">
  <StyledCheckboxPartial />
</div>

<div slot="CheckboxGroup.vue">
  <StyledCheckboxGroupPartial />
</div>
...
const schema = defineSchema(
  z
    ...
    .max(2, 'You can only select up to 2 drinks'),
);
</script>
...
<template>
  <CheckboxGroup
    ...
    description="Select up to 2 drinks"
    :schema="schema"
  >
